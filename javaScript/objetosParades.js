...
const revestimientoMicroCemento = [
    {
        id: '1',
        nombre: ' MICROCEMENTO  ',
...
console.log(revestimientoMicroCemento);

const revestimientoStuccoVeleziano = [{
    id: '2',
...
console.log(revestimientoStuccoVeleziano);

const revestimientoPedraFlex = [{
    id: '3',
    nombre: 'PEDRAFLEX',
