...
const revestimientosPisosResponsivo = [
    {
        id: '1',
        nombre: ' MICROCEMENTO ',
...
console.log(revestimientosPisosResponsivo);



const revestimientosPisosPorcelanatoResponsivo = [{
    id: '2',
...
console.log(revestimientosPisosPorcelanatoResponsivo)
